...
export default function ScrewedContentPanel() {
  return (
    <div className="relative max-xl:line-t max-xl:h-84">
      <div className="absolute inset-0 -mx-px md:p-2">
        <div className="overflow-hidden bg-background/35 md:rounded-2xl flex size-full items-center justify-center">
                ...
                return (
                  ...
                  >
                    {column.map(({ id, url }) => (
                      <div
                        key={id}
                        className="p-8 aspect-square bg-[#a0b1ca] flex justify-center items-center"
                      >
                        <Image
                          src={url}
                          alt={id}
